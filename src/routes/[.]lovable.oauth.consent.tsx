  ...
  return (
    <main className="grid min-h-screen place-items-center bg-background p-6">
      <div className="card-soft w-full max-w-md p-8">
        <p className="font-display text-2xl text-primary">Kindred</p>
        <h1 className="mt-4 font-display text-3xl">Connect {clientName} to your account</h1>
        <p className="mt-3 text-sm text-muted-foreground">
          This lets {clientName} use Kindred as you — reading care recipients, shifts, care plans and
        ...
        <p className="mt-3 text-xs text-muted-foreground">
          This does not bypass Kindred's permissions or backend policies.
        </p>
        {error && (
        ...
        <div className="mt-6 flex gap-3">
          <button
            disabled={busy}
            onClick={() => decide(true)}
            className="flex-1 rounded-full bg-primary px-4 py-3 font-medium text-primary-foreground transition hover:bg-primary/90 disabled:opacity-60"
          >
          ...
          <button
            ...
            className="flex-1 rounded-full border border-border px-4 py-3 font-medium transition hover:border-primary/60 disabled:opacity-60"
          >
            Cancel connection
          </button>
        </div>
