...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Kindred — caregiving coordination" },
      { name: "description", content: "Kindred keeps caregivers, clients, and families on the same page — schedules, care plans, visit logs and messages in one warm, calm workspace." },
      { name: "author", content: "Kindred" },
      { property: "og:title", content: "Kindred — caregiving coordination" },
